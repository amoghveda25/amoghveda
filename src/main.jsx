...
const products = {
  mask: {
    ...
    sub: "Deep nourishment that repairs, revitalizes and transforms your hair.",
    image: "/images/mask.png",
    badge: "BESTSELLER",
    benefits: maskBenefits,
    how: [
    ...
    note: "Hair Mask is the hero treatment product. Use shampoo after the mask for best results."
  },
  shampoo: {
    title: "AmoghVeda Herbal Shampoo",
    sub: "A gentle, natural shampoo to cleanse and nourish your hair after the hair mask.",
    image: "/images/shampoo.png",
    badge: "SUPPORTING PRODUCT",
    benefits: shampooBenefits,
    how: [
      "Wet hair thoroughly.",
    ...
    note: "Shampoo is the supporting product, designed to gently wash off the Hair Mask."
  }
};
  ...
  return (
    <header className="header">
      <a className="logo" href="#home">
        <span className="brandName">Amogh<span>Veda</span><i>leaf</i></span>
        <small>Nature. Ayurveda. You.</small>
      </a>
      <nav>
    ...
    <section id="home" className="hero">
      ...
      <div className="heroCopy">
        ...
        <p className="heroPara">
          Repair damaged hair, reduce hair fall, control frizz and restore natural
          strength with the power of Ayurveda.
        </p>
      ...
      <div className="heroProductArea">
        <div className="seal">BEST<br/>SELLER</div>
        <img className="heroMask" src="/images/mask.png" alt="AmoghVeda Hair Mask" />
        <img className="heroShampoo" src="/images/shampoo.png" alt="AmoghVeda Herbal Shampoo" />
        <div className="heroIngredients">
          <span className="aloe"></span><span className="amla"></span><span className="reetha"></span><span className="hibiscus"></span>
        </div>
      </div>
    </section>
  );
...
function ProductCard({ type, setActive }) {
  ...
  return (
    <article className={`productCard ${isMask ? "bestCard" : ""}`}>
      ...
      <div className="productText">
        <h3><small>AmoghVeda</small>{isMask ? "Hair Mask" : "Herbal Shampoo"}</h3>
        <p>{product.sub}</p>
...
function Combo({ openWhatsApp }) {
  return (
    <section className="combo">
      <div className="comboImageGroup">
        <img src="/images/mask.png" alt="Hair Mask" />
        <b>+</b>
        <img src="/images/shampoo.png" alt="Shampoo" />
      </div>
      <div className="comboCopy">
        <h2>Complete Hair Care Combo</h2>
        <h3>Hair Mask + Herbal Shampoo</h3>
        <div className="comboPoints">
  ...
  return (
    <section id="ingredients" className="section ingredients">
      ...
      <div className="ingredientGrid">
        {ingredients.map(([name, text, icon]) => (
          <div className="ingredient" key={name}>
            <div className="ingredientPic">{icon}</div>
            <h4>{name}</h4>
            <p>{text}</p>
          </div>
        ))}
...
function Ritual() {
  const steps = [
    ...
    ["Wait 20–30 Minutes", "Let the natural herbs nourish deeply."],
      ...
      <div className="steps">
        {steps.map(([title, desc], i) => (
          <div className="step" key={title}>
            <div className="stepCircle">{i + 1}</div>
  ...
  return (
    <footer id="contact" className="footer">
      <div className="footerBrand">
        <h3>Amogh<span>Veda</span></h3>
        <p>Nature. Ayurveda. You.</p>
        <p>Inspired by Ayurveda. Crafted with care.<br/>For healthy hair & a better you.</p>
        <div className="socialIcons">◎ f ☘</div>
      </div>
      <div>
        <h4>Quick Links</h4>
        <a href="#home">Home</a><a href="#products">Products</a><a href="#ingredients">Ingredients</a><a href="#how-to-use">How to Use</a><a href="#contact">Contact</a>
      </div>
      <div>
        <h4>Our Products</h4>
        <a href="#products">Hair Mask</a><a href="#products">Herbal Shampoo</a><a href="#products">Combo Pack</a>
      </div>
      <div>
        <h4>Contact Us</h4>
        <p>✉ care@amoghveda.com</p>
        <p>☏ +91 88610 64303</p>
        <p>🌐 www.amoghveda.com</p>
        <button className="footerBtn" onClick={() => openWhatsApp()}>Order on WhatsApp</button>
      </div>
    </footer>
  );
}
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modalGrid">
          ...
          <div>
            ...
            <p>{product.sub}</p>
            <h4>Key Benefits</h4>
            <div className="pills">{product.benefits.map(b => <span key={b}>{b}</span>)}</div>
            <h4>Ingredients</h4>
            <p className="listText">Aloe Vera • Amla • Reetha • Shikakai • Bhringraj • Hibiscus • Neem • Fenugreek • Natural Fragrance • Other Natural Ingredients</p>
            <h4>How To Use</h4>
            <ol>{product.how.map(x => <li key={x}>{x}</li>)}</ol>
            <div className="pairing">{product.note}</div>
